    ...
    return (
        ...
        <div className='container-second flex flex-col gap-2 lg:gap-4 items-center justify-center sm:flex-row'>
            ...
            <div className='rounded-lg border-[1px] sm:h-[700px] flex flex-col items-center justify-center border-[#F5613F] w-[90%] min:[1600px]:max-w-[600px] p-4'>
                ...
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>HTML o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>CSS o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>Bootstrap o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>Tailwind css o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>Materila Ui o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>Ant design o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>SASS o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>Javascript o'rganish</Link>
                <Link className='hover:bg-gray-300 p-3 underline lg:text-[18px]' href='https://t.me/UzDev_Education'>Firebase o'rganish</Link>
